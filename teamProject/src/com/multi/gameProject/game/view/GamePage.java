...
import com.multi.hdbc_h.controller.UsersController;
...
public class GamePage extends JFrame {
    ...
    private int problem = 10;
    private int ietm1, ietm2, ietm3, soc;
    private int ietmcount1, ietmcount2, ietmcount3;
    private GameT gameT;
 ...
 private GeneralUserDto loginDto;
        ...
        public void run() {
            ...
            try {
                ...
                while (spentTime < gametime) {
                    now = new Date();
                    timeL.setText("시간:" + (gametime - spentTime - 1));
            ...
            if (gametime == spentTime) {
                ...
                JOptionPane.showMessageDialog(f, "시간종료");
    ...
    private void initMidP() {
        ...
        btn1.addActionListener(new AbstractAction() {
            @Override
            public void actionPerformed(ActionEvent e) {
                if (gameout || problem < 1) {

                    titleL.setText("문제 종료");
                    count = count + (gametime - spentTime) * 10;
                    textArea.setVisible(false);
                    resultL.setText("10문제를 모두 풀었습니다");
                    gameT.interrupt();
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(f, "숫자를 입력하시오");
